    ...
    <div class="flex h-screen">
        ...
        <aside id="sidebar" class="w-80 flex flex-col" style="background-color: var(--bg-primary); border-right: 1px solid var(--border);">
            ...
            <nav class="flex-1 px-4 py-3" style="overflow-y: auto; overflow-x: hidden;">
                ...
                <a href="/time-machine-ml-api-guide" class="sidebar-link <?php echo ($page ?? '') == 'time-machine-ml-api-guide' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-2 rounded-full mb-1" style="color: <?php echo ($page ?? '') == 'time-machine-ml-api-guide' ? 'var(--text-primary)' : 'var(--text-secondary)'; ?>;">
                ...
                <a href="/google-news-api-guide" class="sidebar-link <?php echo ($page ?? '') == 'google-news-api-guide' ? 'active' : ''; ?> flex items-center space-x-3 px-4 py-2 rounded-full mb-1" style="color: <?php echo ($page ?? '') == 'google-news-api-guide' ? 'var(--text-primary)' : 'var(--text-secondary)'; ?>;">
                    <i data-feather="rss" style="width: 20px; height: 20px;"></i>
                    <span class="text-base font-medium">Google News API Guide</span>
                </a>
